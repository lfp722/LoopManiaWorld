...
public class EnemyTest {
    ...
    public void testBasicMove() throws FileNotFoundException {
        ...
        world.addEnemy(slug);
        slug.move(world);
        assertFalse((world.getEnemies().get(0).getPosition().getCurrentPositionInPath() - prevPosition) > 3);
        Enemy zombie = new Zombie(position, 0);
        world.addEnemy(zombie);
        zombie.move(world);
        assertFalse((world.getEnemies().get(1).getPosition().getCurrentPositionInPath() - prevPosition) > 3);
